...
const TypeList = ({ searchParams }) => {
    ...
    const type_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/type/type_delete/${id}`, {
                method: "POST",
    ...
    const type_search = () => {
        setLoading(true);
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/type/type_search`, {
            multiSearch,
            selectedColumns,
            searchQuery,
            statusFilter,
    ...
    const all_types = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/type/type_all/${currentPage}/${dataPerPage}`;
    ...
    const type_print = async () => {
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/type/type_search`, {
                selectedColumns,
                searchQuery,
                statusFilter,
                selectedOrder,
    ...
    const type_delete_searching = id => {
        ...
        if (proceed) {
            axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/type/type_delete/${id}`)
                .then(response => {
    ...
    const type_PDF_download = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/type/type_pdf`, {
                method: 'POST',
                headers: {
