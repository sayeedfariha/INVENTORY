              ...
              <div className="card2 h-100 mb-4 shadow-sm bg-gradient-info">
                <div className="card-body p-2 d-flex justify-content-between align-items-center">
                  ...
                  <div className="col-8 float-right p-0 text-end">
                    ...
                    <h6 className="card-title text-white m-0 text-right">Total Product</h6>
                  </div>
                </div>
              </div>
              ...
              <div className="card3 h-100 mb-4 shadow-sm bg-gradient-warning">
                <div className="card-body p-2 d-flex justify-content-between align-items-center">
                  ...
                  <div className="col-8 float-right p-0 text-end">
                    ...
                    <h6 className="card-title text-white m-0 text-right">Total Sell</h6>
                  </div>
                </div>
              </div>
              ...
              <div className="card4 h-100 mb-4 shadow-sm bg-gradient-danger">
                <div className="card-body p-2 d-flex justify-content-between align-items-center">
                  ...
                  <div className="col-8 float-right p-0 text-end">
                    ...
                    <h6 className="card-title text-white m-0 text-right">Total Purchase</h6>
                  </div>
                </div>
              </div>
            </div>
