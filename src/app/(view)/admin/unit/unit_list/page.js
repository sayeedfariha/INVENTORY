...
const UnitList = ({ searchParams }) => {
    ...
    const unit_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/unit/unit_delete/${id}`, {
                method: "POST",
    ...
    const unit_search = () => {
        setLoading(true);
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/unit/unit_search`, {
            multiSearch,
            selectedColumns,
            searchQuery,
            statusFilter,
    ...
    const all_unit = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/unit/unit_all/${currentPage}/${dataPerPage}`;
    ...
    const unit_print = async () => {
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/unit/unit_search`, {
                selectedColumns,
                searchQuery,
                statusFilter,
                selectedOrder,
    ...
    const unit_delete_searching = id => {
        ...
        if (proceed) {
            axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/unit/unit_delete/${id}`)
                .then(response => {
    ...
    const unit_PDF_download = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/unit/unit_pdf`, {
                method: 'POST',
                headers: {
