...
const BrandList = ({ searchParams }) => {
    ...
    const brand_search = () => {
        ...
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/brand/brand_search`, {
            multiSearch,
            selectedColumns,
            searchQuery,
            statusFilter,
    ...
    //     queryKey: ['pageUsers'],
    //     queryFn: async () => {
    //         const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/brand/brand_all/${currentPage}/${dataPerPage}`)
    ...
    const brand_print = async () => {
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/brand/brand_search`, {
                selectedColumns,
                searchQuery,
                statusFilter,
                selectedOrder,
            ...
            editWindow.document.write('<html><head><title>Inventory Software</title><style> @page { size: ' + selectedPrintSize + ' ' + orientation + '; } @media print { @page { size: ' + selectedPrintSize + ' ' + orientation + '; } } table { width: 100%; border-collapse: collapse; } th, td { border: 1px solid black; padding: 8px; text-align: left; } thead { background-color: gray; } body { text-align: center; } </style></head><body>');
    ...
    const brand_PDF_download = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/brand/brand_pdf`, {
                method: 'POST',
                headers: {
    ...
    const brand_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/admin/brand/brand_delete/${id}`, {
                method: "POST",
    ...
    const brand_delete_searching = id => {
        ...
        if (proceed) {
            axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/brand/brand_delete/${id}`)
                .then(response => {
