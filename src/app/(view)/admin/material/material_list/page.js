...
const MaterialList = ({ searchParams }) => {
    ...
    const material_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/material/material_delete/${id}`, {
                method: "POST",
    ...
    const material_search = () => {
        setLoading(true);
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/material/material_search`, {
            multiSearch,
            selectedColumns,
            searchQuery,
            statusFilter,
    ...
    const material_list = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/material/material_all/${currentPage}/${dataPerPage}`;
    ...
    const material_print = async () => {
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/material/material_search`, {
                selectedColumns,
                searchQuery,
                statusFilter,
                selectedOrder,
    ...
    const material_delete_searching = id => {
        ...
        if (proceed) {
            axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/material/material_delete/${id}`)
                .then(response => {
    ...
    const material_PDF_download = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/material/material_pdf`, {
                method: 'POST',
                headers: {
