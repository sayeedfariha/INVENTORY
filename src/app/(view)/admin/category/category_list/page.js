...
console.log(columnListSelectedArray)
    ...
    const category_search = () => {
        setLoading(true);
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/category/category_search`, {
            multiSearch,
            selectedColumns,
            searchQuery,
            statusFilter,
...
const caregory_list = async () => {
    const url = `${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/category/category_all/${currentPage}/${dataPerPage}`;
...
const category_delete = id => {
    ...
    if (proceed) {
        fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/category/category_delete/${id}`, {
            method: "POST",
...
const category_print = async () => {
    try {
        const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/category/category_search`, {
            selectedColumns,
            searchQuery,
            statusFilter,
            selectedOrder,
...
const category_delete_searching = id => {
    ...
    if (proceed) {
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/category/category_delete/${id}`)
            .then(response => {
...
const [errorr, setErrorr] = useState(null);
    ...
    const category_PDF_download = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/category/category_pdf`, {
                method: 'POST',
                headers: {
