...
const WarrantyList = ({ searchParams }) => {
    ...
    const warranty_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/warranty/warranty_delete/${id}`, {
                method: "POST",
    ...
    const warranty_search = () => {
        setLoading(true);
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/warranty/warranty_search`, {
            multiSearch,
            selectedColumns,
            searchQuery,
            statusFilter,
    ...
    const all_warranty = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/warranty/warranty_all/${currentPage}/${dataPerPage}`;
    ...
    const warranty_print = async () => {
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/warranty/warranty_search`, {
                selectedColumns,
                searchQuery,
                statusFilter,
                selectedOrder,
    ...
    const warranty_delete_searching = id => {
        ...
        if (proceed) {
            axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/warranty/warranty_delete/${id}`)
                .then(response => {
    ...
    const warranty_PDF_download = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/warranty/warranty_pdf`, {
                method: 'POST',
                headers: {
