...
const PeriodList = ({ searchParams }) => {
    ...
    const period_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/period/period_delete/${id}`, {
                method: "POST",
    ...
    const period_search = () => {
        setLoading(true);
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/period/period_search`, {
            multiSearch,
            selectedColumns,
            searchQuery,
            statusFilter,
    ...
    const all_period = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/period/period_all/${currentPage}/${dataPerPage}`;
    ...
    const period_print = async () => {
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/period/period_search`, {
                selectedColumns,
                searchQuery,
                statusFilter,
                selectedOrder,
    ...
    const period_delete_searching = id => {
        ...
        if (proceed) {
            axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/period/period_delete/${id}`)
                .then(response => {
    ...
    const period_PDF_download = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/period/period_pdf`, {
                method: 'POST',
                headers: {
