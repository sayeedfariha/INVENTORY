...
const ListProduct = ({ searchParams }) => {
    ...
    const product_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/product/product_delete/${id}`, {
                method: "POST",
    ...
    const product_search = () => {
        ...
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/product/product_search`, {
            multiSearch,
            selectedColumns,
            searchQuery,
            statusFilter,
    ...
    const getUsers = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/product/product_list/${currentPage}/${dataPerPage}`;
    ...
    const product_print = async () => {
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/product/product_search`, {
                selectedColumns,
                searchQuery,
                statusFilter,
                selectedOrder,
    ...
    const product_delete_searching = id => {
        ...
        if (proceed) {
            axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/product/product_delete/${id}`)
                .then(response => {
    ...
    const product_PDF_download = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/product/product_pdf`, {
                method: 'POST',
                headers: {
