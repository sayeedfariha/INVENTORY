...
const AdminTemplateEdit = ({ id }) => {
	...
	const admin_template_edit = async (event) => {
		...
		// ${process.env.NEXT_PUBLIC_API_URL}:5004/admin/create_side_menu
		// http://192.168.0.185:5004/submit-form
		// http://192.168.0.185:5004/admin/create_side_menu
		// ${process.env.NEXT_PUBLIC_API_URL}:5004/admin/update_side_menu/${id}
		fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/admin/update_side_menu/${id}`, {
			method: 'PUT',
			headers: {
														...
														<div className="container-fluid ">
															...
															<div className='d-flex gap-3 mt-3'>
																...
																<div style={{ marginTop: '-8px', marginLeft: '10px' }}>
																	...
																	<p style={{ marginTop: '-5px', color: projectNameColour ? projectNameColour : adminPanelSettingsEdit[0]?.project_name_color }}><strong>Inventory</strong></p>
																</div>
															</div>
