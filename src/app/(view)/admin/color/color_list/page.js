...
const ColorList = ({searchParams}) => {
    ...
    const color_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/color/color_delete/${id}`, {
                method: "POST",
   ...
   const color_search = () => {
       setLoading(true);
       axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/color/color_search`, {
        multiSearch,
           selectedColumns,
           searchQuery,
           statusFilter,
...
const color_list = async () => {
   const url = `${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/color/color_all/${currentPage}/${dataPerPage}`;
...
const color_print = async () => {
    try {
        const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/color/color_search`, {
            selectedColumns,
            searchQuery,
            statusFilter,
            selectedOrder,
...
const color_delete_searching = id => {
    ...
    if (proceed) {
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/color/color_delete/${id}`)
            .then(response => {
...
const [errorr, setErrorr] = useState(null);
    const color_PDF_download = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5004/Admin/color/color_pdf`, {
                method: 'POST',
                headers: {
